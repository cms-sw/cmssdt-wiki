...
## [docker-build-container](https://cmssdt.cern.ch/jenkins/job/docker-build-container)
...
**Description:** This job keeps last 9 weeks (2 months) of data in Elasticsearch open, and it closes older indexes (archive it).
